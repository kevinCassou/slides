---
title: "PALLAS"
subtitle: "laser-plasma accelerator test falicility @ IN2P3"
author: "Kevin CASSOU"
...
library(metathis)
meta() %>%
  meta_name("github-repo" = "https://github.com/kevinCassou/slides_1") %>% 
  meta_social(
...
| &emsp; CS-IN2P3 &emsp; | &emsp; 20210208
...
non linear regime $a>1$, in 1D, plasma wakefield 
...
so many way to surf the plasma wake waves... when increasing the laser driver intensity ( $a_0$ ): 
...
**-** continuous injection<sup>2</sup>
...
.tiny[
[1] [H. Ekerfelt, et al. , Sci Rep, vol. 7, no. 1, p. 12229, Dec. 2017,](10.1038/s41598-017-12560-8)</br>
[2] [J. Götzfried et al., ‘Physics of High-Charge Electron Beams in Laser-Plasma Wakefields’, Phys. Rev. X, vol. 10, no. 4, p. 041015, Oct. 2020,](https://link.aps.org/doi/10.1103/PhysRevX.10.041015)
]
...
**+** easy to implement drive wake into breaking:</br>
the .orange[so called bubble regime]

**-** high laser laser intensity

**-** highly nonlinear difficult to control

.tiny[
[1] Pukhov, A. & Meyer-ter Vehn, J. Laser wakefield acceleration: the highly non-linear broken-wave regime. Appl. Phys. B 74, 355–361 (2002)<\br>
[2] Faure, Geddes, Mangles in Nature 431 (2004)
]
...
For production of $500 >E>100$ MeV, in a large vacuum chamber: 
...
- target: supersonic gas jet 1-4 mm/gas cell 1-50mm, capillary discharge (>100mm)
- gas: $H_2$ or $He$ ( $+0.1-10\% N_2$ )
- density: $1-20\times10^{18}$ $W/cm^2$ 

]

.pull-right[

img of the experimental setup
...
[1] [M. Labat et al., ‘Robustness of a plasma acceleration based free electron laser’, Phys. Rev. Accel. Beams, vol. 21, no. 11, p. 114802, Nov. 2018](https://link.aps.org/doi/10.1103/PhysRevAccelBeams.21.114802)


[2] [T. André et al., ‘Control of laser plasma accelerated electrons for light sources’, Nat Commun, vol. 9, no. 1, p. 1334, Dec. 2018](http://www.nature.com/articles/s41467-018-03776-x) 
...
# <img style="vertical-align:top" src="img/logo-eupraxia.png" height="96px"/>

### .blue[European initiative for innovative accelerator based on plasma accelerator technology]

.pull-left[
European Research infrastructure for development of  

- Compact GeV accelerator
- Compact FEL  
- Associated secondary sources : X, Gamma, Positrons 
...
# <img style="vertical-align:middle" src="img/logo-eupraxia.png" height="96px"/>

**CDR 2016 -2019**<sup>1</sup>, foreseen two sites:

- beam-driven plasma accelerator for compact FEL @ LNF - Italy [EuPRAXIA@SPARC_LAB](https://indico.cern.ch/event/977732/contributions/4118096/attachments/2151321/3627291/CERN_LNF_020.pdf)<sup>1</sup>
- Laser- driven plasma accelerator  ? To be decided.   

In review for the **ESFRI roadmap**, 2020-2023, .blue[CNRS commit to R&D preparatory phase only !] 

.footnote[
[1] A. R. Rossi, V. Petrillo, A. Bacci et al.
...
.blue[**07/2019**]: <img style="vertical-align:middle" src="img/logo-gdrappel.png" height="36px"/> discussion 2 projects emerged structuring a potential French contribution to **EuPRAXIA**
...
- Part of the material to upgrade the laser system to 300 TW, 0.1Hz existing
...
<img style="vertical-align:middle" src="img/logo-smilei.png" height="32px"/>  numerical experimental platform  [<img style="vertical-align:middle" src="img/icon_github.png" height="32px"/>](https://smileipic.github.io/Smilei/)
...
- Collaboration project gathering the community (LLR,LOA, IJClab) to access to GENCI HPC resources 
<br>
.tiny[
...
.center[<img style="vertical-align:middle" src="img/logo-amplitude.png" height="52px"/>&emsp; &emsp; <img style="vertical-align:middle" src="img/logo-thales.jpeg" height="62px"/>]
]
]
...
- Phased effort on control and not ultimate performance 
- Deliver continuous 10 Hz beam to enable machine studies
...
| frep | .red[10] | 10 | 10 | Hz |
| energy spread | 1 | <1 | <1 | mm.mrad |
| stability | 5% | 3% | 1% | -  |
...
[1] [1]R. Assmann, ‘EuPRAXIA Conceptual Design Report’, Hamburg, 2019. [Online]. Available: https://desycloud.desy.de/index.php/s/X37pwaJxEGi2God.
...
- <img src="img/logo-tango.png" height="20px"/> control command, webpage based gui
...
- staged implementation : from the source to more and more complex electron beamline
- but parallel development : [plasma cell test bench](#plasmacell) , online laser field control [ML-COLA]()<sup>1</sup> 
- Simulation support: reinforce collaboration between experimental and numerical people
...
### 2020-2022:  base of the LPI facility  <img src="img/logo-cper.png" height="30px"/> <img src="img/logo-upsay.png" height="30px"/>&emsp;<img src="img/logo-cnrs.png" height="30px"/>

* **infrastructure upgrade** : renovation, network, PHIL reconfiguration 

* **laser transport** : design on going fabrication 

* **laser driver commissioning** :  .blue[laser transport, compression, injection and focalization module]
...
* **e- characterization beam line**: .blue[ design and realization and installation]


 .center[.red[**first e- beam parameter optimization run at 10Hz.**]]

]

.panel[.panel-name[phase 2]

### 2023-2024: laser driver upgrade - PIA3-PACIFICS <img src="img/logo-pia3.jpg" height="20px"/>
...
* beam quality & control optimization studies
...
### 2024-2026: e- beam transport - PIA3-PACIFICS <img src="img/logo-pia3.jpg" height="20px"/>
...
* control of the laser driver is the key 
  ...
  * 2 active pointing stabilization system [.small[target value 0.2urad (RMS)]]
  
      
* bring errors of laser pulse properties below <1%.

* online development of **laser field** monitoring (spatio-temporal distortion) 
...
* based on self-truncated ionization injection
* optimization/tolerancing of laser parameters, limited to $a_0=1.15\pm0.8$ and $\tau_L = 40\pm3$ fs (FWHM) 
* optimization plasma longitudinal profile 

=> used Azymutal modes geometry and envelop approximation for the laser.  
...
- Rayleigh length of the laser $Z_r=\pi w_0^2/\lambda_0 \sim 1.3\,$mm
- Plasma wavelength $\lambda_p \approx 10-30\,\mu m$ 
- Betatron wavelength $\lambda_\beta =\sqrt{2\gamma_e}\lambda_p \sim 250-800$ cm $^{-3}$


Tailoring plasma density profile: 

- **to control injection** : density down-ramp assisted truncated ionization injection <sup>1</sup> 
 in unmatched laser condition => narrowing of the injection length <sup>2</sup>
- **tune** the injected **charge / beam loading** <sup>3</sup>
- **tune** e- **beam energy** / acceleration length
- **limit emittance growth** at the exit of the plasma : 
Minimized Twiss parameters (matched focus strength of the ramp) 
Control of the exit down ramp is crucial !  

.center[ .red[**... all of this in only few mm**]  ]
...
.footnote[
[1] [F. Brandi and L. A. Gizzi, ‘Optical diagnostics for density measurement in high-quality laser-plasma electron accelerators’, High Pow Laser Sci Eng, vol. 7, p. e26, 2019](https://www.cambridge.org/core/product/identifier/S2095471919000112/type/journal_article); Phasics, ‘SID4 High resolution wavefront sensor, http://phasicscorp.com/cameras/sid4/ (2020).

[2]

[3] K. Wang, ‘Design study of a Laser Plasma Wakefield Accelerator with an externally injected 10-MeV electron beam coming from a photoinjector’, PhD, 2019.
...
.red[COMPLETER GRAPH A JOUR avec PIA3 75% ]
