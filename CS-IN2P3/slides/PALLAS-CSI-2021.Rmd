...
```{r echo=FALSE, out.width="90%",fig.pos="!b"}
knitr::include_graphics("img/lpa-driver-scheme1.svg")   
```
...
```{r echo=FALSE, out.width="90%",fig.pos="!b"}
knitr::include_graphics("img/lpa-driver-scheme2.svg")   
```
...
* **84 %** of the budget is consolidated. 
* budget relies on:
