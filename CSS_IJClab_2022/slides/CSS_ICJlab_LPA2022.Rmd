...
E. Baynard, A. Beck, C. Bruni, K. Cassou, J.L. Coacolo, J. Demailly, D. Douillet, P. Drobniak, P. Gauron, A. Gonnin, C. Guyot, E. Jules, G. Iaquaniello, G. Kane, S. Kazamias, V. Kubytsky, E. Legay, B. Lucas, Y. Peinaud, K. Malkinski, F. Massimo, D. Minenna, P. Nghiem, M. Pittman, O. Neveu, A. Specka
...
e- beam source 
* Synergy with compact light source development [EuPRAXIA](http://www.eupraxia-project.eu/)  

**Feed integrated design studies**
* refine **performance limits** in key-element towards collider requirement  (drivers / targetry etc ...) 
* hands-on **training** of **future generation** of accelerator engineer/physicist
...
* About 20-25 FTE permanent research/engineer spread in 6 different labs and 4 laser facilities ! 
...
* [**LAPLACE**]() <img style="vertical-align:middle" src="img/logo-loa.png" height="32px"/>: Laser Plasma Acceleration Center aiming to develop the following axis
  - High repetiton LPA sources for X generation application: 100 Hz, 100 MeV
  - High energy LPA sources >1 GeV single stage<sup>1</sup>, 1Hz and applications
Radiography and irradiation applications
* .blue[**PALLAS** <img style="vertical-align:middle" src="img/logo-ijclab.png" height="22px"/>: Prototype accelerator plasma based technology ; laser plasma injector (LPI) test facility (150-250 MeV, 10-100pC, 10Hz) aiming to bring LPI stability and control comparable to RF accelerator.]

### HPC resources 

* **VIRTUALAPLACE** gathering all CNRS and CEA labs involved in plasma acceleration in France for access to [GENCI](https://www.genci.fr/en) HPC national resources ~ 10M h.cpu (A. Beck, LLR)

[National facility **APOLLON**](): Multi-PW laser facility for exploratory experiments on laser-matter interaction in ultra-high intensity regime. Call based user access for 2 target area short /long focal length for LPA experiments. 

.small[[1] Oubrerie, K. et al. Controlled acceleration of GeV electron beams in an all-optical plasma waveguide. Light Sci Appl 11, 180 (2022).
]
...
# In steps approach toward reliable high-quality beam

Research and development lines:
1. advanced .red[**laser control**]: challenge with high intensity laser system (industrial collaboration required)
...
3. electron .orange[**beam control and transport**]: start versatile beamline for characterization.
...
Specific strategical skill to be reinforced: machine learning,  plasma physic/ computing scientist  

Non specific: magnet, cabling, control-command 

Funds: funded by IN2P3, CPER, ICJlab and PIA3-PACIFICS project.  Total estimated cost in equipment: >3.5 M€ - secured fund ~ 2.4 M€. No fund for post-doc estimated requirement: ~ > 4 years 

SWOT analysis see : [back slide](#swot)  

**Special focus on HR vs skill**: [back slide](#specialfocushr)
...
.small[courtesy of G. Iaquaniello]
---
...
.small[courtesy of G. Iaquaniello, A. Gonnin, Y. Peinaud, D. Douillet]
---
...
* Various integration configurations exist for plasma target gas-cell type: 
...
`r fontawesome::fa("triangle-exclamation", fill ="#00294B" )` Effort to be coordinated at European level between different target labs (DESY, LNF-INFN..) $\Rightarrow$ .qblue[**EuPRAXIA preparatory phase**] 
...
.center[
```{r echo=FALSE, out.width="60%"}
  knitr::include_graphics("img/CFD_simulations.png")
```
]]
.pull-left.w30[
- Prototype developments
- Beam production test planned for 05/2023
...
.pull-left.w80[
Test bench for plasma target cell with a 2 TW laser beam *PlasmaCell* beamline LASERIX.
...
Update control for the stabilization of 40TW 10Hz LASERIX laser system @ IJClab, collaboration with [Amplitude Laser](https://amplitude-laser.com/)
...
---
# Example: high speed large aperture mirror final focus stabilization
- .qblue[Reach **< 0.3 urad**] (rms stability) on target. Currently 3-7 urad (rms)  
...
- MHz witness beam under validation 
- On going qualification test of femtosecond broadband coating on SiC: IBS stress compensation and LIDT under vacuum [2] $\Rightarrow$ challenge to combine high LIDT and control stress without back face compensation

.small[
[1]: MRC gmbh, [2]: MERSEN/OPTOMAN/LIDARIS  
]
...
* **PALLAS** project is building  a **10Hz laser-plasma accelerator test facility** with an exciting program for the next 5 years on high quality e- injector recognized as one of the key milestones in the accelerator roadmap [1]. 

* **PALLAS** is complementary to existing facilities (LOA, LUX, FLAME-LNF) or/and an intermediate step for starting project ([LAPLACE](https://www.ensta-paris.fr/en/node/906), [KALDERA](http://mls.desy.de/kaldera))

* **Push back the laser-plasma technology frontiers** to high reliability and control $\rightarrow$ will open new insight for beam shape and phase space control

* Very active team on the project which is .orange[*a new comer*] in the field is building a machine in less than 4 years
  - First results are coming [2]
  - Team is growing collaborations in discussion: CEA-IRFU, LOA, LNF-INFN
  - Reinforcing collaborations with industry is mandatory for laser driver: Amplitude laser, Image optics, local micro machining ceramic company, ...
...
---
name:eCBL
# Versatile beamline for LPA characterization 
.center[
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("img/eCBL.png")
```
]
...
.pull-left.w40[
- Synergy with EuPRAXIA for FEL, important progress in the demonstration. 
- table extracted from AF-6 snowmass report<sup>1</sup>
<br>
<br>
<br>
.small[
[1]. Geddes, C., Hogan, M., Musumeci, P. & Assmann, R. Report of Snowmass 21 Accelerator Frontier Topical Group 6 on Advanced Accelerators. Preprint at http://arxiv.org/abs/2208.13279 (2022).

]

]
.pull-right.w60[.center[
```{r echo=FALSE, out.width="100%"}
...
# Dive into laser-plasma acceleration
.center[
```{r echo=FALSE, out.width="90%"}
knitr::include_graphics("img/lpa-demo-kaldera.png")
```
]

 
.center[Watch it:  [http://kaldera.desy.de](http://kaldera.desy.de)]

.small[plasma acceleration group *et al.* DESY]
...
---
name:TWAC
background-image: url(img/TWAC.png)
...
---
name:specialfocushr
# Special focus on HR vs skill 

.center[
```{r echo=FALSE, out.width="70%"}
knitr::include_graphics("img/walid_table.png")
```
]
...
last version available [here](https://kevincassou.github.io/slides/CSS_IJClab_2022/slides/CSS_ICJlab_LPA2022.html#1)
