...
interactive slides, full version available here: 

[https://s.42l.fr/pallas](https://s.42l.fr/pallas)
...
.blue[**07/2019**]: GDR organzed $\rightarrow$ discussions 2 projects emerged structuring a potential French contribution to <img style="vertical-align:middle" src="img/logo-eupraxia.png" height="52px"/>
.center[
...
View of the plasma test bench under commissioning with long testing gas cell from Esculap project<sup>3</sup>
...
.small[*Note : see last slides for references detail*]
...
control of the laser driver is the key 
  ...
  * 3 spectrometers (+1)
  * .orange[**spectral control loop**]: ultra broadband dazzler + additional wizzler => correct high phase order 
...
[2] image credits : [MERSEN](https://www.mersen.com/fr/produits/specialites-graphite/boostecr-carbure-de-silicium-sic/systemes-laser-miroirs-de-scanners-galvometriques-et-autres-miroirs-ultra-rapides)
]
