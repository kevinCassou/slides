...
overview of the LASERIX laser driver system
...
current status without feedback and optimization: 
.pull-left[
...
* LASERIX laser input
* generic shape for $n_e(x)$ inspired from various ref
* parameter : $x_{foc,vac}$ 
...
* explore different capture/focusing scenarii
* magnets with remote alignment 
...
knitr::include_graphics("img/Schedule-pallas.png")
```
]
