...
- the authors will update continuously the slides (.orange[some back slides may appear])
- the slides are interactive (.blue[link])
- sensitive information as financial details are available on request (contact:  [<img style="vertical-align:middle" src="img/icon_mail.svg" height="24px"/>](mailto: cassou@lal.in2p3.fr))
...
<br>
<br>
.center[.orange[**transition from proof of principle towards accelerators and reliable sources for application**]]
...
- Electron beam stable with large energy spread ~~15%~~<sup>3</sup> .red[~1%]<sup4</sup>, peak brightness  ~~0.5~~ .red[5] pC/MeV @ 1Hz 
...
.pink[**LASERIX**] **40 TW, 10 Hz** laser driver of the .pink[Université Paris Saclay] with unique features in the « new world » of research :

- Constant maintenance and upgrade by Université Paris Sud over a decade (~130k€/year + >800k€ investment CPER POLA) 
...
[2] *src image : A. Irman, M. Downer et al. (2018)*
...
.orange[**50-100 TW class laser system = complex system**] 

overview of the laser driver system

```{r echo=FALSE, out.width="100%",fig.pos="!b"}
knitr::include_graphics("img/lpa-driver-scheme1-V2-current.svg")   
```
...
```{r echo=FALSE, out.width="100%",fig.pos="!b"}
knitr::include_graphics("img/lpa-driver-scheme1-V2.svg")   
```
...
.pull-left[
.blue[**Input**] 
* laser parameters in vacuum (a<sub>0</sub>,t<sub>0</sub>,w<sub>0</sub>,x<sub>0</sub>) 
...
.pull-left[
multi-zone cell design
* add *control-variable* to the plasma profile 
* possibly region / region  

preliminary PIC studies results 
* chair-like density profile
* SMILEI( AM + envelop)
<br>

=> downramp assisted localized ionization

next steps optimization of 
1. injection $Q \Delta E/E$
2. beam emittance 
...
* *e-* divergence
* large $\Delta E/E$
* low charge and 15-20% fluctuations 
* orbit stability
...
* start from PIC simulation parameters
* explore different capture/focusing scenario
* magnets with remote online alignment 
* robust diagnostics: Yag screen, faraday cups
* emittance measurement 
* wide angular acceptance spectrometer
* correctors and BPM 
]
...
* online control laser/plasma/magnets (including magnets alignment)
* machine learning correction 
]

.center[.orange[**+** **additional diagnostic** prevously tested on our photo-injector PHIL for beam duration and **longitudinal phase-space** measurement (THz-TDS cavity)]]
...
* equipment cost well identified **84 %** of the budget is consolidated. 
* budget relies on:
...
* Midterm FTE weakness PIC development for LPA (Smilei 1FTE) and theoretical on laser-plasma interaction must be reinforced
 ...
 **Requirement for IN2P3** : Partly funded (ANR-PIA3, Université Paris Saclay, CPER) <br>
 
 .center[a strong financial support of 564 k€ over 2022-2025 is required to the IN2P3]
